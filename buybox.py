...
class BuyBox(db.Model):
    ...
    zip_codes = db.Column(db.Text)           # comma separated
    ...
    property_types = db.Column(db.Text, default='Single Family')  # comma separated
    conditions = db.Column(db.Text, default='Distressed,Fair,Good')  # comma separated
